...
using _2DStartKit.Core;
using _2DStartKit.Core.Effects;
using _2DStartKit.Core.Inputs;
...
namespace _2DStartKit.Screens
{
    ...
    internal class MainMenuScreen : MenuScreen
    {
        ...
        private void SetLanguageText()
        {
            ...
            Title = "_2DStartKit"; // TODO uncomment this if you want it to use Resources.MainMenu; instead
        }
        ...
        public override void LoadContent()
        {
            ...
            settingsManager ??= ScreenManager.Game.Services.GetService<SettingsManager<_2DStartKitSettings>>();
