...
namespace TRexRunner.Entities
{
	...
	{		
		...
		private const int TEXTURE_HEIGHT = 42;
		...
		public override Rectangle CollisionBox
		{
			get
			{
				Rectangle collisionBox = new Rectangle((int)Math.Round(Position.X), (int)Math.Round(Position.Y), TEXTURE_WIDTH, TEXTURE_HEIGHT);
		...
		{
			Sprite spriteA = new Sprite(spriteSheet, TEXTURE_COORDS_X, TEXTURE_COORDS_Y, TEXTURE_WIDTH, TEXTURE_HEIGHT);
			Sprite spriteB = new Sprite(spriteSheet, TEXTURE_COORDS_X + TEXTURE_WIDTH, TEXTURE_COORDS_Y, TEXTURE_WIDTH, TEXTURE_HEIGHT);
