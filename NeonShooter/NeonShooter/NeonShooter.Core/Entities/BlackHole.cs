...
namespace NeonShooter.Core.Entities
{
	class BlackHole : Entity
	{
		...
		public override void Update()
		{
			...
			if ((MainGame.GameTime.TotalGameTime.Milliseconds / 250) % 2 == 0)
			{
				...
				MainGame.ParticleManager.CreateParticle(Art.LineParticle, pos, color, 190, 1.5f, state);
			}
		...
		public void WasShot()
		{
			...
			float hue = (float)((3 * MainGame.GameTime.TotalGameTime.TotalSeconds) % 6);
